...
//            }
    ...
    function getOptions(){
        ...
        $options->alipayCertPath = '/usr/share/nginx/html/laracms/alipayCertPublicKey_RSA2.crt';

        $options->alipayRootCertPath = '<-- 请填写您的支付宝根证书文件路径，例如：/foo/alipayRootCert.crt" -->';
        $options->alipayRootCertPath = '/usr/share/nginx/html/laracms/alipayRootCert.crt';

        $options->merchantCertPath = '<-- 请填写您的应用公钥证书文件路径，例如：/foo/appCertPublicKey_2019051064521003.crt -->';
        $options->merchantCertPath = '/usr/share/nginx/html/laracms/appCertPublicKey_2021001165602449.crt';
