```bash
curl -X <?php echo e($route['methods'][0]); ?> <?php echo e($route['methods'][0] == 'GET' ? '-G ' : ''); ?>"<?php echo e(rtrim($baseUrl, '/')); ?>/<?php echo e(ltrim($route['boundUri'], '/')); ?>" <?php if(count($route['headers'])): ?>\
...
```<?php /**PATH /Users/lu/PhpstormProjects/jet-api/vendor/mpociot/laravel-apidoc-generator/src/../resources/views//partials/example-requests/bash.blade.php ENDPATH**/ ?>