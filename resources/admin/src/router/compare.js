        ...
        children: [
            {
                ...
                children: [{
                    path: '/position/list',//推荐位列表
                    name: '推荐位列表',
                    component: resolve => { require(['@/views/operate/position/list.vue'], resolve) },
                },
                    {
                        path: '/position/save',
                        name: '添加推荐位',
                        component: resolve => { require(['@/views/operate/position/edit.vue'], resolve) },
                    },
                    {
                        path: '/position/list/content/by/type',//按照类型查看内容
                        name: '按照类型查看内容',
                        component: resolve => { require(['@/views/operate/position/contentByType.vue'], resolve) },
                    }]
            },
            {
                path: '/link',
                ...
                children: [
                    {
                        path: '/area/list',//地区管理
                        name: '查看地区',
                        component: resolve => { require(['@/views/operate/area/list.vue'], resolve) },
                    },
                ]
            },
            // {
