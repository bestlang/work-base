    ...
    public function run()
    {
        ...
        \DB::table('cms_ads')->insert(array (
            ...
            array (
                ...
                'id' => 4,
                'image' => 'http://jetcdn.larashop.com/uploads/720305.png',
                'name' => '首页右侧第一个广告位-1',
                'position_id' => 3,
            ...
            array (
                ...
                'id' => 5,
                'image' => 'http://jetcdn.larashop.com/uploads/720305-1.png',
                'name' => '首页右侧第一个广告位-2',
                'position_id' => 3,
                'start_time' => '2020-06-01 02:00:00',
                'target' => '_black',
                'text' => NULL,
                'tiny_image' => 'http://jetcdn.larashop.com/uploads/home-select-fill2.png',
                'type' => 1,
